...
(function ($) {
	...
	$('body').append('<div id="swipebox-overlay"></div>');
	...
	$.swipebox = function(elem, options) {
		...
		html = '<div id="swipebox-slider"></div>\
		...
		var ui = {
			...
			build : function(){
				var $this = this;
				$('#swipebox-overlay').append(html);
				$('#swipebox-overlay').css('visibility', 'visible');
	          ...
	          e.preventDefault();
	       		...
	       		$('.touching').off('touchmove').removeClass('touching');
					...
					$('body').bind('mousedown', function(e){
						...
						endCoords = e.originalEvent;
						startCoords.pageX = e.originalEvent.pageX;
						console.log(startCoords);

						$('.touching').bind('mousemove',function(e){
							e.preventDefault();
							e.stopPropagation();
							endCoords = e.originalEvent;
							...
							index *= -1; // invert number
							currCoords = width*index+distance;
							if (index === 0 && distance > 0) { currCoords = 0 };
							if ($('#swipebox-slider .slide').length === (index*-1+1) && distance < 0) {
								 currCoords = width*index 
							};
							console.log(currCoords);
							$('#swipebox-slider').css('transform', 'translate3d(' + (currCoords) + 'px, 0, 0)');
						});
			...
			destroy : function(){
				...
				$('#swipebox-slider').remove();
				$('#swipebox-caption').remove();
				$('#swipebox-action').remove();
				$('#swipebox-overlay').css('opacity', '0');
				$('#swipebox-overlay').css('visibility', 'hidden');
				if (!$.isArray(elem))
